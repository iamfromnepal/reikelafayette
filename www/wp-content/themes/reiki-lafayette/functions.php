<?php
/**
 * Reiki Lafayette functions and definitions
 *
 ...
 */
function reiki_lafayette_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Reiki Lafayette, use a find and replace
		* to change 'reiki-lafayette' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'reiki-lafayette', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'reiki_lafayette_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'reiki_lafayette_setup' );
 ...
 */
function reiki_lafayette_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'reiki_lafayette_content_width', 640 );
}
add_action( 'after_setup_theme', 'reiki_lafayette_content_width', 0 );
 ...
 */
function reiki_lafayette_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'reiki-lafayette' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'reiki-lafayette' ),
...
add_action( 'widgets_init', 'reiki_lafayette_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'reiki_lafayette_scripts' );
