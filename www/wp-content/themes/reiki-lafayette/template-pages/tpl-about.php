        ...
        <div class="col-md-6 hero__content-block text-center">
            <div class="font-nelphim font-size-lg block-width-350 mx-auto">
                ...
                <div class="border-mini border-mini--center mb-1 mb-lg-2">
                    <p>I’m Inge. I’m the creator, founder & mentor behind Reiki Montreal.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="has-bg-img container-alt pt-xl-8 pb-xl-6 pt-md-5 pb-md-2 pt-2 pb-1">
    ...
    <div class="container block-width-625 font-size-18 text-center">
        ...
        <div class="counter-list">
            <ul>
                <li>No matter how stuck you feel, you too have that little voice of intuition inside of you. Maybe she even sent you here. Listen.</li>

                <li>You don’t need to know how things will play out in advance. I promise.</li>

                <li>The most gorgeous person who you can become is EXACTLY who you are – underneath the patterns that don’t work for you. Everything we do here at Reiki Montreal serves that purpose: Whether you feel stuck in the darkest of places or just need a little guidance, we help you become who you are.</li>
            </ul>
        </div>
    </div>
</section> <!-- /section -->
...
<section class="container-alt py-3">
    ...
    <div class="row align-items-center mb-3 mb-xl-6">
        <div class="col-lg-6">
            <div class="block-width-350 py-2 mx-lg-auto font-avenir font-size-lg font-300">
                ...
                <ul>
                    <li>Bachelors of Psychology from McGill University (2010)</li>
                    <li>Certificate in Energy Medicine from NHC Institute (525h) (2012)</li>
                    <li>Masters of Neuropsychology from Université de Montréal (2013)</li>
                </ul>
            </div>
        </div>
        <div class="col-lg-6 has-bg-img py-2 py-xl-3">
            ...
            <div class="max-width-510 font-avenir font-size-lg font-300 pl-xl-4">
                ...
                <ul>
                    ...
                    <li>Over 700 clients served.</li>
                    <li>Over 100 students taught.</li>
                    <li>Over 12 fully empowered energy healers formed (who have gone through all 7 courses of the Reiki Certificate or equivalent).</li>
                    <li>Continued hours of workshops & retreats for my continuing education.</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="block-width-625 mx-auto font-avenir font-size-lg font-300 mb-2">
        ...
        <ul>
            ...
            <li>I’m a Manifesting Generator / INFJ / Virgo sun, Pisces ascendent, Gemini moon.</li>
            <li>I speak English, French & Dutch fluently.</li>
            <li>I’ve been married since 2018 to a wonderfully good-hearted and honest man.</li>
            <li>We’re live in Nun’s Island in Montreal, but travel at the very least 2 months every winter.</li>
