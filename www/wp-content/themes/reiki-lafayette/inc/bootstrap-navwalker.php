...
class WP_Bootstrap_Navwalker extends Walker_Nav_Menu
{
	...
	public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
	{
		...
		if ('' !== $linkmod_type) {
			...
			if ($this->has_children != true) {
				...
				$item_output .= '</a><span class="caret icon-arrow-line-right"></span>';
			}
		}
	...
	public static function fallback($args)
	{
		...
		$fallback_output .= '<li class="nav-item"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="nav-link" title="' . esc_attr__('Add a menu', 'blusky') . '">' . esc_html__('Add a menu', 'blusky') . '</a></li>';
		$fallback_output .= '</ul>';
