...
<section class="hero hero-home has-bg-img container-alt py-3">
	<picture class="bg-img">
		<source media="(min-width: 576px)" srcset="/media/home-hero-bg.webp" type="image/webp">
		<source media="(min-width: 576px)" srcset="/media/home-hero-bg.jpg" type="image/jpg">
		<source srcset="/media/home-hero-bg-mobile.webp" type="image/webp">
		<source srcset="/media/home-hero-bg-mobile.jpg" type="image/jpg">
		<img src="/media/home-hero-bg.jpg" alt="Home Hero Background" width="1440" height="862" loading="lazy">
	</picture>
	<div class="container">
		<div class="content-block d-flex flex-column justify-content-between justify-content-lg-center">
			<h1 class="heading-primary text-center text-white mb-2 mb-lg-3">Your <strong>Energy Healing Journey</strong> Starts Here.</h1>
...
<section class="has-bg-img container-alt pt-xl-5 pt-3 pb-7 pb-xl-10">
	<picture class="bg-img">
		<source media="(min-width: 576px)" srcset="/media/home-form-feature-bg.webp" type="image/webp">
		<source media="(min-width: 576px)" srcset="/media/home-form-feature-bg.jpg" type="image/jpg">
		<source srcset="/media/home-form-feature-bg-mobile.webp" type="image/webp">
		<source srcset="/media/home-form-feature-bg-mobile.jpg" type="image/jpg">
		<img src="/media/home-form-feature-bg.jpg" alt="Home Hero Background" width="1440" height="702" loading="lazy">
	</picture>
	<div class="container">
		<div class="block-width-625 mx-auto">
			<div class="box-light box-light--mb font-500 text-center">
				<h2 class="heading-tertiary text-center mb-2 m-md-0">When we say <br>your energy healing journey starts here, <strong>We Mean it.</strong></h2>
		...
		<div class="block-width-625 mx-auto font-avenir font-300 px-1">
			<div class="avatar-circle-wrapper offset-top-sm offset-top-lg mb-1">
				<picture class="avatar-circle">
					<source srcset="/media/reiki-montreal-avatar.webp" type="image/webp">
					<source srcset="/media/reiki-montreal-avatar.png" type="image/png">
					<img src="/media/reiki-montreal-avatar.png" alt="Reiki Montreal Avatar" width="160" height="160" loading="lazy">
				</picture>
			</div>

			<div class="text-center font-nelphim font-400 mb-3 mb-lg-2">
				<h2 class="heading-primary heading-primary--sm">A warm-hearted <strong>Welcome</strong></h2>
...
<section class="container-alt home-slider-section px-0">
	<div class="home-slider verticalSlider-col-1 hide-arrow vertical-dots">
		<div class="home-slider__item has-bg-img text-center">
			<picture class="bg-img">
				<source media="(min-width: 576px)" srcset="/media/home-slides-bg.webp" type="image/webp">
				<source media="(min-width: 576px)" srcset="/media/home-slides-bg.jpg" type="image/jpg">
				<source srcset="/media/home-slides-bg-mobile.webp" type="image/webp">
				<source srcset="/media/home-slides-bg-mobile.jpg" type="image/jpg">
				<img src="/media/home-slides-bg.jpg" alt="Home Slides Background" width="1440" height="702" loading="lazy">
			</picture>
			<div class="content-wrap pt-sm-5 pt-2 overlay overlay-53--top overlay-53--bottom">
				<h2 class="heading-secondary text-white text-center"><strong>Who is</strong> Reiki Montreal</h2>
		...
		<div class="home-slider__item has-bg-img text-center">
			<picture class="bg-img">
				...
				<source srcset="/media/home-slides-bg-mobile.webp" type="image/webp">
				<source srcset="/media/home-slides-bg-mobile.jpg" type="image/jpg">
				<img src="/media/home-slides-bg.jpg" alt="Home Hero Background" width="1440" height="702" loading="lazy">
			</picture>
